...
async function post_data(d) {
    try{
        ...
        if(notifys.length>0){
            ...
            console.log("Qx-Appmonitor：🥴 No change")
        }
    }catch (e) {
        console.log(e);
    }
