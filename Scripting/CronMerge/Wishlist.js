...
function notify(notifys){
    ...
    console.log(notifys);
    $notify(" Wishlist", "🥳 Price or version app has changed\n🤩 New apps have been added to the list", notifys)
}
function flag(x){
