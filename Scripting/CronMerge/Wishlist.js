...
function notify(notifys){
    ...
    console.log(notifys);
    $notify(" Wishlist","","🥳 Price or app version has changed\n🤩 New apps have been added to the list",notifys)
}
function flag(x){
